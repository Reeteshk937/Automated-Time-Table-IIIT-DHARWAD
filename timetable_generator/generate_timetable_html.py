...
.container {{ background: #fff; margin: 40px auto; padding: 32px; border-radius: 16px; box-shadow: 0 8px 32px 0 rgba(31, 38, 135, 0.15); max-width: 900px; }}
...
a {{ display: inline-block; margin-bottom: 16px; color: #4f8cff; text-decoration: none; font-weight: bold; }}
...
{html_table}
    ...
    # --- Generate index.html (interactive version) ---
    sem_data = {}
